...
// ! this component saves the coin on clicking
const SavedBtn = ({ id }) => {
  ...
  return (
    <button onClick={(e) => handleClick(e)}>
      <svg
        className={`w-[1.5rem] cursor-pointer hover:fill-cyan ${
...
const Saved = () => {
  ...
  return (
    <section className="w-[90%] h-full mt-52 lg:mt-44 mb-32 relative">
      <div className="w-full min-h-[60vh] border border-gray-100 rounded">
        {savedData ? (
          <table className="w-full table-auto">
            <thead
              className="capitalize text-gray-100 text-base font-medium
          border-b border-gray-100 "
            ...
            <tbody>
              {savedData?.map((coin) => (
                <tr
                  key={coin.id}
                  className="text-center border-b border-gray-100 hover:bg-gray-200"
                >
                  <td className="py-4 px-2 flex items-center gap-2">
                    <SavedBtn id={coin?.id} />
                    <img className="w-[1.5rem]" src={coin?.image} alt="" />
                  ...
                  <td
                    className={`py-4 ${
                      coin?.market_cap_change_percentage_24h < 0
                        ? "text-red md:table-cell hidden"
                        : "text-green md:table-cell hidden"
                    }`}
                  >
                  ...
                  <td
                    className={`py-4 ${
                      coin?.price_change_percentage_1h_in_currency < 0
                        ...
                        : "text-green lg:table-cell hidden"
                    }`}
                  >
                    {Number(
          ...
          <h1 className="text-md md:text-lg text-cyan min-h-[60vh] w-full flex items-center justify-center">
